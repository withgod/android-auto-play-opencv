...
from . import emulator_controller_pb2 as emulator__controller__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in emulator_controller_pb2_grpc.py depends on'
...
class EmulatorController(object):
    ...
    @staticmethod
    def injectWheel(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def streamInputEvent(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
